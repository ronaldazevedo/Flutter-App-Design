...
import 'package:flutter_ui_design/Football Live Score App/Model/live_match_model.dart';
import 'package:flutter_ui_design/Football Live Score App/Widgets/live_match_stats.dart';
import 'package:flutter_ui_design/Football Live Score App/constants.dart';
              ...
              child: Column(
                children: [
                  ...
                  LiveMatchStats(
                    ...
                    homeValue:
                        widget.liveMatch.shotOnTarget.toDouble() / 10,
                    awayValue:
                  ...
                  LiveMatchStats(
                    ...
                    awayValue:
                        widget.liveMatch.possession.toDouble() / 100,
                    isHomeWinner: true,
                  ),
                  ...
                  LiveMatchStats(
                    ...
                    title: "Yellow Cards",
                    homeValue:
                        widget.liveMatch.yelloCard.toDouble() / 10,
                    awayValue:
                        widget.liveMatch.yelloCard.toDouble() * 2 / 10,
                    isHomeWinner: false,
                  ),
                  ...
                  LiveMatchStats(
                    ...
                    title: "Red Cards",
                    homeValue:
                        widget.liveMatch.redCard.toDouble() / 10,
                    awayValue:
                        widget.liveMatch.redCard.toDouble() * 2 / 10,
                    isHomeWinner: false,
                  ),
                  ...
                  LiveMatchStats(
                    ...
                    title: "Corner Kicks",
                    homeValue:
                        widget.liveMatch.corner.toDouble() / 5,
                    awayValue:
                        widget.liveMatch.corner.toDouble() / 5,
                    isHomeWinner: true,
                  ),
